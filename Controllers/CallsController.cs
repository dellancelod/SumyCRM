    ...
    public class CallsController : Controller
    {
            ...
            [FromHeader(Name = "X-API-KEY")] string? apiKey)
        {
            ...
            AudioTranscriptionOptions options = new()
            {
                ...
                Prompt = "Це звернення до міських служб. Ім'я та прізвище, адреса в місті Суми, Україна, може містити дріб. Українська мова. Звернення може стосуватися таких тем: маршрутки, транспорт, теплопостачання, робота ліфтів, водовідведення, водопостачання, енергопостачання, зв'язок, гаряче водопостачання, благоустрій, вуличне освітлення, ремонт житла, газопостачання"
            };
